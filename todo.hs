...
main = do
    _ <- system "clear"
    putStrLn "Welcome to the sittiest TO-DO List app, made by Lima 2024"
    ...
    putStrLn " 4 - Blow up Israel army"
    putStrLn " 5 - Exit"
    ...
    case option of
        ...
        4 -> do
            ...
            putStrLn $ "Kaboom! " ++ show num ++ " Genocidals were dead or severely injured."
